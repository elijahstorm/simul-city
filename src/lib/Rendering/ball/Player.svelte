<script lang="ts">
	...
	import { status, movement, handleKeys, rbp, trackHeight } from './state'
	...
	const keydown = (evt: KeyboardEvent) => handleKeys(evt, true)
	const keyup = (evt: KeyboardEvent) => handleKeys(evt, false)
</script>
